...
const MedicalReport = {
  async create({ patient_id, clinic_id, doctor_id, report_type, file_url, description, report_date }) {
    ...
    await db.execute(
      `INSERT INTO medical_reports (id, patient_id, clinic_id, doctor_id, report_type, file_url, description, report_date)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
      [id, patient_id, clinic_id, doctor_id || null, report_type, file_url, description || null, dateStr]
    );
