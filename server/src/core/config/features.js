const FEATURE_DEFINITIONS = Object.freeze({
  staff_management: ['staff_management', 'staff management', 'team access', 'team management'],
  analytics: ['analytics', 'advanced analytics', 'financial analytics'],
  advanced_emr: ['advanced_emr', 'advanced emr', 'emr notes', 'emr records'],
  financial_reports: ['financial_reports', 'financial reports', 'revenue reports'],
  digital_prescriptions: ['digital_prescriptions', 'digital prescriptions', 'e-prescriptions'],
  packages: ['packages', 'service packages', 'consultation packages', 'service_packages', 'consultation_packages', 'care packages'],
  messaging: ['messaging', 'secure messaging', 'direct messaging', 'chat'],
